...
- ⚠ 2026-09-05 환경 버그 2건 수정(판정기 기준점 매핑, 옷 낙하 높이 34cm → 공식과 같은 ~3cm;
  `AUDIT.md` §E). 수정 후 우승자 모델은 120회 **85.8%**(공식 리더보드 74.5%)로 정합.
  이전 성적(소형 47.5% / 우승자 46~50%)은 수정 전 환경 기준.
- **고친 환경 성적 (2026-09-07)**: 우승자 모델 **85.8%**(120회), 소형 모델 최고 **77.1%**
  (`act_student_combo`, 시연 674회 학습, 240회 평가, Unseen 72.5%). 결과 표는 `RESULTS.md`
