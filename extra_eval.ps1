...
$port = 8768
$mark = "$base\extra_eval_markers.log"
...
# Checkpoint-selection check (audit item): is the 40k checkpoint of the best model better than 60k?
Mark "extra_eval: cur 040000 (seeds 401..412)"
Eval-All "$base\outputs\act_student_cur\checkpoints\040000\pretrained_model" "cur40k_n5" 400
Mark "EXTRA-EVAL-DONE"
