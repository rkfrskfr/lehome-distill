...
$port = 8768
$mark = "$base\extra_eval2_markers.log"
...
# Second 120-episode pass of the best model with disjoint seeds -> headline number on n=240.
Mark "extra_eval2: cur 060000 second pass (seeds 701..712)"
Eval-All "$base\outputs\act_student_cur\checkpoints\060000\pretrained_model" "cur_n5b" 700
Mark "EXTRA-EVAL2-DONE"
